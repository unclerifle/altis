	...
	player createDiaryRecord ["serverrules",
		[
			"Communication Rules", 
				...
				4. Teamspeak channels are split up into areas for a reason. Cops must be in the IAA channels at all times.<br/>
				5. Civilians cannot be in any IAA channels on teamspeak in order to gather information on their location or movements. Civs caught doing this will be removed the channel. Repeat offenders can be kicked or banned from both the game and teamspeak.<br/><br/>
				"
		]
	];
...
// Police Section
	...
	player createDiaryRecord ["policerules",
		[
			"Illegal Areas", 
				"
				1. Gang areas are not considered illegal. Thus a IAA may enter without a raid, but may not restrain or stop anyone inside without probable cause/illegal activity. (Talking to the gang NPC is NOT probable cause/illegal activity.)<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3 in a designated IAA channel. Failure to be on Teamspeak during an admin check will result in your immediate dismissal from the server.<br/>
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				F: IAA Siren (if cop)<br/>
				T: Vehicle Trunk<br/>
				Left Shift + R: Restrain (IAA Only)<br/>
				...
				Left Shift + L: Activates IAA siren lights (as a cop).<br/>
