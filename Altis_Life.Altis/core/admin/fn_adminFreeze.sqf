...
if(life_frozen) then {
	...
	[[0,format["Admin %1 has enabled a players input.",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	...
	[[0,format["Admin %1 has disabled a players input.",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	life_frozen = true;
