...
if(life_markers) then {
	...
	[[0,format["Admin %1 has enabled player markers.",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
...
FinishedLoop = true;
	...
	[[0,format["Admin %1 has Disabled player markers.",profileName]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
