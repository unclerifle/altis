...
switch (_var) do
{
	...
	case "life_inv_rubyc": {"Ruby Cut"};				// UR Custom
	case "life_inv_research": {"Research"};				// UR Custom
	case "life_inv_researchp": {"Research Processed"};  // UR Custom
	...
	//License Block
	case "license_civ_ruby": {"Ruby Processing"};					// UR Custom
	case "license_civ_research": {"Research Processing"}; 			// UR Custom
