...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "ruby": {_var = "license_civ_ruby"};			// UR Custom
			case "research": {_var = "license_civ_research"};   // UR Custom
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_ruby": {_var = "ruby"}; 		// UR Custom
			case "license_civ_research": {_var = "research"}; // UR Custom
			default {_var = ""};
		};
	};
};
