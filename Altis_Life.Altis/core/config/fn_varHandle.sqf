...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			case "ruby": {"life_inv_ruby"}; 		  // UR Custom
			case "rubyc": {"life_inv_rubyc"}; 		  // UR Custom
			case "research": {"life_inv_research"};   // UR Custom
			case "researchp": {"life_inv_researchp"}; // UR Custom
	...
	case 1:
	{
		switch (_var) do
		{
			case "life_inv_ruby": {"ruby"};			// UR Custom
			case "life_inv_rubyc": {"rubyc"};    	// UR Custom
			case "life_inv_research": {"research"};  // UR Custom
			case "life_inv_researchp": {"researchp"}; // UR Custom
